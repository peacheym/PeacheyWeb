  ...
  return (
    <Container>
      ...
      <p>
        ...
        undergraduate degree. I have been fortunate enough to work with the GEM
        Lab as both a USRA recipient as well as an honours student. I have been
        working with various teams at GEM Lab since early 2020, and have
        contributed to several exciting and multi-disciplinary projects in that
        time.
      </p>
      <p>
        ...
        technologies and how to best represent the data they produce. We are not
        looking for a singular best way, but rather looking to represent the
        data in such a manner that as many use cases can be easily implemented
        with one structure. This work is currently ongoing, and this page will
        be updated appropriately as progress is made.
      </p>
      <p>
