      ...
      <Box maxW="6xl" margin="0px auto">
        <TL>
          ...
          >
            ...
            involving Human Computer Interaction, Augmented &amp; Virtual
            Reality, and more. I have also collaborated on projects with other
            faculties at Dalhousie as well as external research groups such as
            MSR.
            <br />
            <br />I am excited to collaborate on projects involving HCI, ML,
            DMIs and other topics, so please get in touch!
          </Event>
          <Event
            interval={"2017 – 2021"}
            ...
            subtitle={"Dalhousie University"}
          >
            I graduated from Dalhousie with a Bachelor of Computer Science
            (First Class Honours) in 2021. I also earned a certificate in
            Communications Technology &amp; Cyber Security during my degree. My
            Classwork included topics such as Machine Learning, Network
            Computing, Cloud Computing and more!
            <br />
            <br />
        ...
        <TL>
          ...
          >
            ...
            domain security profile. This project used React, Node, GraphQL, and
          ...
          >
            As a software developer at Ultra Electronics Maritime Systems I
            worked on an agile team to implement features for UEMSs suite of
            services using Java, C++, and Python.
          </Event>
        </TL>
      </Box>
    </Box>
